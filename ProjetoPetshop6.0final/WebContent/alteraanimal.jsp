...
<!-- Apresentação de erros -->
	...
	<form action="cadastraanimal" method="post">
            ...
            <table>
			<tr><td>Nome:
			<input type="text" name="nome" size="30" value="${animal.nome}"  ><p></td></tr>
			</table>
			<table>
			<tr><td>Tipo:&nbsp;
			<select  name="tipo"><option value =""> </option>
  			<option value="1"  ${animal.tipo eq 'CACHORRO'  ? 'selected' : ''} >Cachorro</option>
  			<option value="2" ${animal.tipo eq 'GATO' ? 'selected' : ' ' } >Gato</option>
  			
  			</select></td><td>
		&nbsp;&nbsp;	Raça:</td><td>
			<input type="text" name="raca" size="13" value="${animal.raca}"></td></tr>
			<tr><td>Porte: <select name="porte">
			<option value="">       </option>
  			<option value="1" ${animal.porte eq 'PEQUENO' ? 'selected':''}>Pequeno</option>
  			<option value="2" ${animal.porte eq 'MEDIO' ? 'selected':''}>Médio</option>
  			<option value="3" ${animal.porte eq 'GRANDE' ? 'selected':''}>Grande</option>
  			
  			</select> </td><td>&nbsp;&nbsp; Peso:</td><td> <input type="text" name="peso" size="13" value="${animal.peso}"  > </td></tr>
							<tr><td></td><td> <br><center><input type="submit" value="Alterar"></center></td></tr>
			<tr><td> <input type="hidden" name="atualizar" value="1"> </td></tr>
  			<tr><td><input type="hidden" name="codigo" value="${animal.codigo}"></td></tr>
  			</table>
			</center>
