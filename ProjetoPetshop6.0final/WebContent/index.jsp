      ...
      <!-- Modal content-->
		<div class="modal-content">
			...
			<div class="modal-body" style="padding:40px 50px;">
				...
				<br><button type="submit" class="btn btn-success btn-block" style="width:100px;">Enviar</button>
</form>
	...
	<div class="jumbotron">
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<ol class="carousel-indicators">
				...
				<li data-target="#carousel-example-generic" data-slide-to="2"></li> <!-- qtd Quantidade de bolinhas deve ter a mesma quantidade de fotos no slide -->
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<a href="#"><img src="imagens/vacina.jpg" width="1600" hight="898" alt="slide1" class="center"></a>
					
				</div>
			
				<!-- Imagens -->
				<div class="item">
					<a href="#"><img src="imagens/vacinacachorro.jpg" width="1600" hight="898" alt="slide2" class="center"></a>
					
				</div>
				
				
				<div class="item">
					<a href="#"><img src="imagens/Taxidog.jpg" width="1600" hight="898" alt="slide2" class="center"></a>
					
				</div>
				
				<div class="item">
					<a href="#"><img src="imagens/gato.jpg" width="1600" hight="898" alt="slide2" class="center"></a>
					
				</div>
				
				<div class="item">
					<a href="#"><img src="imagens/banho.jpg" width="1600" hight="898" alt="slide2" class="center"></a>
					
				</div>
				
				
				<div class="item">
					<a href="#"><img src="imagens/tosa.jpg" width="1600" hight="898" alt="slide2" class="center"></a>
