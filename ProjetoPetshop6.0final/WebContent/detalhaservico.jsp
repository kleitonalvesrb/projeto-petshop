...
<div class="col-xs-12 col-sm-9">
	...
	<div class="jumbotron"><center>
        ...
        <center><h2>Detalhamento do Serviço</h2><br>
        <table><tr><td>
     		<b>Data: </b></td><td><c:out value="${agenda.trataString()}"></c:out>
     		
     		<tr><td><b>Horario:&nbsp; </b></td><td><c:out value="${agenda.hora}:00"></c:out>
     		
     		<tr><td><b>Taxi: </b></td><td><c:out value="${agenda.buscar ? 'Foi solicitado o uso do taxi dog' : 'Não foi solicitado o uso do taxi dog'}"></c:out>
     		
     		<tr><td><b>Animal: </b></td><td><c:out value="${agenda.animal.nome}"></c:out>
     		
     		<tr><td><b>Tipo: </b></td><td><c:out value="${agenda.animal.tipo}"></c:out>
     		
     		<tr><td><b>Porte: </b></td><td><c:out value="${agenda.animal.porte}"></c:out>
     		
     		<tr><td><b>Raça :</b></td><td><c:out value="${agenda.animal.raca eq '' ? 'Raça não informada' : agenda.animal.raca }"></c:out>
        	
        	<tr><td><b>Serviço: </b></td><td> <c:out value="${agenda.servico.descricao}"></c:out>
        	
        	<tr><td><b>Valor: </b></td><td><c:out value="R$ ${agenda.servico.valor}"></c:out>
