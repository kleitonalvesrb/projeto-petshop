...
<h2>Detalhamento da Consulta</h2><br><br>
        <center><table><tr><td>
     		<b>Data consulta: </b></td><td><c:out value="${agenda.trataString()}"></c:out></td>
     		
     		<tr><td><b>Horario: </b></td><td><c:out value="${agenda.hora}:00"></c:out></td>
     		
     		<tr><td><b>Taxi: </b></td><td><c:out value="${agenda.buscar ? 'Foi solicitado o uso do taxi dog' : 'Não foi solicitado o usdo do taxi dog'}"></c:out></td>
     		
     		<tr><td><b>Animal: </b></td><td><c:out value="${animal.nome}"></c:out></td>
     		
     		<tr><td><b>Tipo: </b></td><td><c:out value="${animal.tipo}"></c:out></td>
     		
     		<tr><td><b>Porte: </b></td><td><c:out value="${animal.porte}"></c:out></td>
     		
     	<tr><td><b>Raça :</b></td><td><c:out value="${animal.raca eq '' ? 'Raça não informada' : animal.raca }"></c:out></td>
        	
        	<tr><td><b>Peso: </b> </td><td><c:out value="${animal.peso}Kg"></c:out></td>
        	
        	<tr><td><b>Problema relatado: &nbsp;</b></td><td><c:out value="${agenda.consulta.descricao}"></c:out></td>
        	</table>
     		<br>
     		<br>
     		<br>
     	<center>	<a href="minhaconta"> <input type="button" value=" Voltar "></a></center>
