    	...
    	<c:if test="${not empty loginUsuario }">
			<c:if test="${not empty servicos}">
				...
				<center>
					...
					<br>
					<form action="agendaservico" method="post">
					<!-- ANIMAIS DISPONIVEIS -->
					<table>
						<tr>
						...
						<tr>
						<td>Selecione os serviços desejados:</td></tr>
						</table>
						<table>
						<tr><td>
							...
							<c:forEach var="s" items="${servicos}">
								<tr>
									<td><input type="checkbox" name="descricao"
										value="${s.codigo}"> <c:out value="${s.descricao}"></c:out></td>
										<td>
										&nbsp;&nbsp; <c:out value="R$ ${s.valor}"></c:out></td>
								</tr>
							</c:forEach></td></tr>
						</table>
<p>
						<table>
							<tr>
								<td>Data:</td>
								<td><input type="date" name="dataCadastro"	value="${s.dataCadastro}" placeholder="05/02/2015" /></td>
							</tr>
							<td><p></td>
							<tr>
						...
						<br> <input type="checkbox" name="taxiDog" value="1"> Buscar
			...
			<c:if test="${empty servicos}">
         	<center> <font color="red"><h2> Desculpe, nenhum serviço cadastrado até o momento :( </h2> </font> </center>
         
         </c:if>
         </c:if>
         <c:if test="${empty loginUsuario }">
				<center> <font color="red"> <h2>Você precisa estar logado para solicitar um serviço!</h2></font><br><br><br><br><br><br> </center>
			</c:if>
