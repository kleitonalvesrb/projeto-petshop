...
<c:if test="${not empty sucess}">
 ...
 <!-- AKIIIIIIIIIIIIIII -->
 	<!-- Apresentaçao da lista de erros na tela -->
        ...
        <center><h2>Cadastrar Serviço</h2><BR><br></center>
         <form method="post" action="criaservico" name="cadastro"> 
       <center>
        <table>
			<tr><td>Descrição:</td><td> <input type="text" name="descricao" size="25" value="${param.descricao}" maxlength="45" ></td></tr>
			<tr><td><p></td></tr><tr><td>Valor:</td><td>
		    <input type="text" name="valor" size="25" value="${param.valor}" maxlength="14">
			<input type="hidden" name="atualizar" size="55" value="0" maxlength="14">
			<input type="hidden" name="disponivel" value="1">
			<tr><td> </td><td><center><br><input type="submit" value="Cadastrar"></center></td></tr>
			</table>
			</center>
			</form>
