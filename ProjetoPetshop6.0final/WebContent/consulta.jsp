			...
			<center>
				<form action="agendaconsulta" method="post">
					...
					<tr>
							...
							</select> <a href='cadastroAnimal.jsp'><span><img
										src='imagens/mais.png' width='18' /></span></a><p></td>
						</tr>
						<tr>
							<td>Data:</td>
							<td></label><input type="date" name="dataCadastro"
								value="${param.dataCadastro}" placeholder="05/02/2015" /><p></td>
						</tr>
						<tr>
							<td>Hora:</td>
							<td><select name="horario">
									<option value="">Selecione</option>
									<option value="8"  ${param.horario eq '8' ? 'selected' : ' '}>8:00</option>
									<option value="10" ${param.horario eq '10' ? 'selected' : ' '}>10:00</option>
									<option value="12" ${param.horario eq '12' ? 'selected' : ' '}>12:00</option>
									<option value="14" ${param.horario eq '14' ? 'selected' : ' '}>14:00</option>
									<option value="16" ${param.horario eq '16' ? 'selected' : ' '}>16:00</option>
							</select><p></td>
						</tr>
						...
						<tr>
							<td>Descrição:</td>
							<td><textarea name="descricao" rows="10" cols="50" title="${param.descricao}"  value="${param.descricao}"></textarea><p></td>
						</tr>
					</table><br>
					<input name="taxiDog" type="checkbox" value="1"> Buscar Pet em Casa (TaxiDog)
					<br> <br><input type="submit" value="Agendar"><br><br>
					 *O atendimento é realizado por ordem de chegada.
				</form>
			</center>
		</c:if>
		<c:if test="${empty nomeUsuario }">
	<center><font color="red"><h2>Você precisa estar logado para agendar uma consulta!</h2></font><br><br><br><br><br><br></center>
</c:if>
