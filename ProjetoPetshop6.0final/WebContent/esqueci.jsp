		...
		<div class="modal-content">
			...
			<div class="modal-body" style="padding:40px 50px;">
				<form role="form" method="post" action="validalogin">
					...
					<p align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="esqueci.jsp">Esqueci minha senha</a></p></div>
					<table><tr><td><button type="submit" class="btn btn-success btn-block" style="width:100px;">Entrar</button></td><td>&nbsp;&nbsp;</td><td>  <a href="cadastro.jsp"> <input type="button" class="btn btn-success btn-block" style="width:100px;" value="Cadastrar"></a></td></tr></table>
				</form>
			</div>
...
<div class="col-xs-12 col-sm-9">
	...
	<div class="jumbotron">
		...
		<form method="post" action="recuperaacesso">
			<label>Login:</label><input type="text" class="form-control" name="login" id="usrname" placeholder="ex: joao" style="width:500px;"><br>
			<br><label>Email:</label><input type="text" class="form-control" name="email" id="usrname" placeholder="ex: joao@gmail.com" style="width:500px;"><br>
			<input type="hidden" name="tipo" value="1"> 
			<button align="right" type="submit" class="btn btn-success btn-block" style="width:100px;">Recuperar</button>
			<br><br>
		</form>
		<div id="hr2"></div>
		<br><br>
		<h2>Recuperar Login</h2>
		<form method="post" action="recuperaacesso" name="cadastro">
			<label>CPF: </label><input type="text" class="form-control" name="cpf" id="usrname" placeholder="000.000.000-00" onblur="ValidarCPF(cadastro.cpf);" onkeypress="MascaraCPF(cadastro.cpf);" maxlength="14" style="width:500px;"><br>
			<br><label>Email:</label><input type="text" class="form-control" name="email" id="usrname" placeholder="ex: joao@gmail.com" style="width:500px;"><br>
			<input type="hidden" name="tipo" value="2">
			<button align="right" type="submit" class="btn btn-success btn-block" style="width:100px;">Recuperar</button></div><!-- Fecha o jumbotron -->
		</form>
...
<footer class="footer">
    <div class="container">
		<p class="text-footer"><label>CNPJ:</label> 19.030.856/0001-38
<label>Endereço:</label> Setor Norte, Quadra 03 Bloco A Loja 06/07 - Brazlândia DF</p>
    </div>
</footer>
