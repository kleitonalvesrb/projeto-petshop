...
<div class="col-xs-12 col-sm-9">
	...
	<div class="jumbotron">
	  ...
	  <!-- Apresentaçao da lista de erros na tela -->
        <center>
        ...
        <!-- Fim da aparesentacao de erros -->
        
        
        <center><h2>Alterar Serviço</h2><br></center>
         <form method="post" action="alteraservico" name="cadastro"> 
       <center>
<table>
		<tr><td>	Descrição: </td><td> <input type="text" name="descricao" size="25" value="${servico.descricao}" maxlength="45" ></td></tr>
		<tr><td>	Valor:</td><td>
		    <input type="text" name="valor" size="25" value="${servico.valor}" maxlength="14">
			<input type="hidden" name="id" size="55" value="${servico.codigo}" maxlength="14">	 
			<input type="hidden" name="atualizar" size="55" value="1" maxlength="14"></td></tr>
			</table><table>
			<tr><td><input type="radio" name="disponivel" value="1" >Disponível &nbsp;&nbsp;
			<input type="radio" name="disponivel" value="0"> Indisponível </td></tr>
			<tr><td><center><br><input type="submit" value="Alterar"></center></td></tr>
			</table>
			</center>
			</form>
